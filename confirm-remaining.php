<?php
// confirm-remaining.php - Manually confirm remaining payment
...
// Update remaining payment in database
$sql = "UPDATE commissions SET 
        remaining_paid = 1, 
        remaining_paid_at = NOW(), 
        remaining_transaction_id = 'DEMO_REMAINING_' . time(),
...
if (mysqli_stmt_execute($stmt)) {
    $_SESSION['message'] = "✅ Remaining payment confirmed! You can now download.";
